        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.edit.products.post', ['id' => $product->product_id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_name" value="{{ $product->product_name }}" placeholder="Tên sản phẩm">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 form-group">
                                                ...
                                                <input type="text" value="{{ $product->price }}" name="price" class="form-control" placeholder="Giá sản phẩm">
                                                {!! $errors->first('price','<span class="text-danger">:message</span>') !!}
                                            </div>
                                            <div class="col-lg-6 form-group">
                                                <label for="sale">Sale (<span class="text-danger">*</span>)</label>
                                                <input type="text" value="{{ $product->sale }}" class="form-control" name="sale" placeholder="Giảm giá">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="test" cols="30" rows="5">{!! $product->description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $product->quantity }}" name="quantity" placeholder="Số lượng">
                                                {!! $errors->first('quantity','<span class="text-danger">:message</span>') !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Chọn Hình (<span class="text-danger">*</span>)</label>
                                            <input type="file" class="form-control" name="image_upload" placeholder="Hình Ảnh">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ get_name_image($product->image) }}" name="image" placeholder="Hình Ảnh">
                                                {!! $errors->first('image','<span class="text-danger">:message</span>') !!}
                                            </div>
                                            <div class="col-lg-4 form-group">
                                                <label>Hiển thị</label>
                                                <input {{ $product->status == 1 ? 'checked' : '' }} class="mt-2 switch-toggle" name="status" id="status" type="checkbox" value="1">
