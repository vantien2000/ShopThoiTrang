<div class="modal-detail d-none" id="detail-product">
    <div class="detail-block" >
        <div class="detail-top">
            ...
            <div class="detail-right text-left ml-3">
                ...
                <div class="detail-infor d-flex">
                    <div class="mr-3">Loại: <span class="type">ABC</span></div>
                    <div class="mr-3">Kích Thước: <span class="size">S </span></div>
                    <div class="mr-3">Số lượng: <span class="quantity">12</span></div>
                </div>
            </div>
        </div>
        <div class="detail-bottom">
            <h4 class="text-left my-3">Thông tin thêm</h4>
            <p class="product-description add-infor-product">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium veniam tempora consequuntur, exercitationem repudiandae doloribus repellat nostrum eaque id magnam officiis molestiae. Quia, eaque? Voluptatibus veritatis id alias. Harum, quasi.
            </p>
        </div>
        <span class="icon-close close-detail-block"></span>
    </div>
</div>
